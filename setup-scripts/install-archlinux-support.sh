...
# Original script: https://github.com/Lancia-Greggori/install-archlinux-support

# Modified to remove support for the now defunct [community] repo
...
if grep -qE '^\[(extra|multilib)\]' /etc/pacman.conf; then
